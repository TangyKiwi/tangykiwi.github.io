+ function() {
		...
		for (f(t) && (n = t, t = e[1] || {}, o++); o < r; o++)
			for (a in e[o])
				if (u = e[o][a], n && (c(u) || (s = T(u)))) {
					var l = t[a];
					s ? (s = !1, l = T(l) ? l : []) : l = c(l) ? l : {}, t[a] = i(n, l, u)
				} else t[a] = u;
		return t
	}
	...
	function b(e) {
		e.cw = e.c.width = p(e.container, "width") || D, e.ch = e.c.height = p(e.container, "height") || I
	}
	...
	function z(e, t) {
		e.set.resize && (e._resizeHandler = function() {
			...
			var o = e.cw / n,
				i = e.ch / r;
			T(e.dots) && e.dots.forEach(function(e) {
				c(e) && (e.x *= o, e.y *= i)
			}), a(t) && t.call(e, o, i), e.paused && e.draw()
	...
	Object.defineProperty && !P || (L = !1, Object.defineProperty = function(e, t, n) {
		e[t] = n.value
	...
	var k = function() {
		...
		_ = function() {
			function t(n, r, o) {
				e(this, t), L && (this.container = v(r) ? r : x.querySelector(r)) && (this.set = i(!0, {}, K.commonConfig, n.defaultConfig, o), this.c = x.createElement("canvas"), this.cxt = this.c.getContext("2d"), this.paused = !1, b(this), this.container.innerHTML = "", this.container.appendChild(this.c), this.color = j(this.set.color), this.observeCanvasRemoved(), this.init(), this.resize())
			}
			return k(t, [{
				key: "requestAnimationFrame",
				value: function() {
					this.canvasRemoved || this.paused || q.requestAnimationFrame(this.draw.bind(this))
				}
			}, {
				key: "observeCanvasRemoved",
				value: function() {
					var e = this;
					this.destructionListeners = [], V(this.c, function() {
						e.canvasRemoved = !0, e._resizeHandler && y(q, "resize", e._resizeHandler), e.destructionListeners.forEach(function(e) {
							e()
						})
					})
				}
				...
				key: "onDestroy",
				value: function() {
					return w.apply(void 0, [this, this.destructionListeners].concat(Array.prototype.slice.call(arguments)))
				}
			}, {
				key: "pause",
				value: function() {
	...
	var V = function() {
			var e = q.MutationObserver || q.WebKitMutationObserver,
				...
				r = function(e, n) {
					var r = function o(r) {
						t(r.target, e) && (document.removeEventListener("DOMNodeRemoved", o), n())
					};
	...
	}(K), K.commonConfig = Q, q.JParticles = K, "function" == typeof define && define.amd ? define(function() {
		return K
